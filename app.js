document.addEventListener('DOMContentLoaded', () => {
    ...
    // --- ACCESO CON MUESTRA DE ERROR LIMPIO ---
    ...
    step1FormRrhh.addEventListener('submit', (e) => {
        ...
        loteEnCreacion = { semanaNum: numSemana, fecha: incDate.value, ciudad: incCity.value, departamento: incDept.value };
    ...
    candidatesMassiveForm.addEventListener('submit', (e) => {
        e.preventDefault();
        baseDatosLotes.push({ id:'lote_'+Date.now(), responsable:currentUser, semana:loteEnCreacion.semanaNum, fecha:loteEnCreacion.fecha, ciudad:loteEnCreacion.ciudad, departamento:loteEnCreacion.departamento, candidatos:[...listaCandidatosTemp] });
